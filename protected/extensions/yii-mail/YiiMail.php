...
class YiiMail extends CApplicationComponent
{
    ...
    */
    public function registerScripts() {
		...
		require dirname(dirname(dirname(__FILE__))).'/vendors/swiftMailer/classes/Swift.php';
		Yii::registerAutoloader(array('Swift','autoload'));
		require dirname(dirname(dirname(__FILE__))).'/vendors/swiftMailer/swift_init.php';
	}
}